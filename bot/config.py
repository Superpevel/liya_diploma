...
MODELS: dict[str, ModelConfig] = {
    "sdxl_r16": ModelConfig(
        ...
        lora_path=RESULTS_DIR / "sdxl_r16_s4000" / "sdxl_logo_lora_r16_s4000"
    ...
    "sdxl_r32": ModelConfig(
        ...
        base="sdxl",
        base_model_id=SDXL_BASE,
        lora_path=RESULTS_DIR / "sdxl_r32" / "sdxl_logo_lora_r32"
    ...
    "sdxl_r4": ModelConfig(
        ...
        base="sdxl",
        base_model_id=SDXL_BASE,
        lora_path=RESULTS_DIR / "sdxl_r4" / "sdxl_logo_lora_r4"
    ...
    "flux_r16": ModelConfig(
        ...
        lora_path=RESULTS_DIR / "flux_r16" / "checkpoint-3500"
